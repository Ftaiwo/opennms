...
public class GenericIndexResourceTypeTest {
    ...
    public void setUp() throws IOException {
        ...
        // Point to a bogus directory by default
        m_resourceStorageDao.setRrdDirectory(new File("/a/bogus/directory"));
    }
    ...
    public void testGetResourceByNodeAndIndexGetLabelStringAttribute() throws Exception {
        ...
        m_fileAnticipator.tempFile(indexDir, ResourceTypeUtils.STRINGS_PROPERTIES_FILE_NAME, "stringAttribute=hello!!!!");
